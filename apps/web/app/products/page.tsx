        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Where precision meets purpose. Every product represents our commitment to 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Three collections, each designed with specific needs in mind, 
              all sharing our commitment to quality and sustainability.
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-green-50 to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900">
              Don't Throw Away. Trade In.
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Your old shoes have value. We believe in circular fashion and zero waste. 
              Send us your worn footwear and we'll give you a discount on your next purchase.
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gold-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Discover footwear that's built to last, designed to perform, and created with 
            respect for our planet. Your perfect pair is waiting.
          </p>
