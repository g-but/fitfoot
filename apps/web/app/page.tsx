          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                {homePageData?.aboutSection?.title || 'Swiss Craftsmanship Excellence'}
              </h2>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                {homePageData?.aboutSection?.description || 'Every product is designed with precision.'}
              </p>
                ...
                {homePageData?.aboutSection?.features && homePageData.aboutSection.features.length > 0 ? (
                  ...
                  <>
                    <li className="flex items-center group">
                      <span className="w-2.5 h-2.5 bg-primary rounded-full mr-4 flex-shrink-0 group-hover:scale-110 transition-transform duration-300"></span>
                      <span className="group-hover:text-foreground transition-colors duration-300">Premium materials</span>
                    </li>
                    <li className="flex items-center group">
                      <span className="w-2.5 h-2.5 bg-primary rounded-full mr-4 flex-shrink-0 group-hover:scale-110 transition-transform duration-300"></span>
                      <span className="group-hover:text-foreground transition-colors duration-300">Swiss design</span>
                    </li>
                  </>
                )}
              </ul>
